...
- User guides: `README.md` is the introduction to the project; the `README-*` guides beside it (install, hardware, tutorials, api, protocol, references) give more in depth detail.
